...
useEffect(() =>{//useEffect hara que la data se ejecute al ver los cambios
  ...
  return (
    <>
    <div style={{display: "grid", height: "500px", gridTemplateColumns: "200px 200px 200px", gap:"10px", columnGap: "50px"}}>
    {Data.map((item) =>
    ...
    <Card key={item.id} style={{  width: '14rem',}}>
      ...
      <ListGroup className="list-group-flush">
        ...
        <ListGroup.Item>Precio del articulo: ₡{item.price}</ListGroup.Item>
